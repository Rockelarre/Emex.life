                            ...
                            <nav className="navbar navbar-expand-md navbar-light">
                                <Link href="/">
                                    <a className="navbar-brand">
                                        <img src="/emex-2.svg" className="main-logo" alt="logo" />
                                        <img src="/emex-2.svg" className="optional-logo" alt="logo" />
                                    </a>
                                </Link>
                                ...
                                <div className={classOne} id="navbarSupportedContent">
                                    <ul className="navbar-nav">
                                        ...
                                        <li className="nav-item">
                                            <Link href="/#">
                                                <a className="nav-link" onClick={e => e.preventDefault()}>
                                                    Páginas <i className="fas fa-chevron-down"></i>
                                                </a>
                                            </Link>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/#">
                                                <a className="nav-link" onClick={e => e.preventDefault()}>
                                                    Projectos <i className="fas fa-chevron-down"></i>
                                                </a>
                                            </Link>
                                        ...
                                        <li className="nav-item">
                                            <Link href="/#">
                                                <a className="nav-link" onClick={e => e.preventDefault()}>
                                                    Tienda <i className="fas fa-chevron-down"></i>
                                                </a>
                                            </Link>
                                    ...
                                    <div className="others-options">
                                        ...
                                        <Link href="/empleo">
                                            <a className="btn btn-primary">Trabaja con Nosotros</a>
                                        </Link>
                                    </div>
                                </div>
                            </nav>
